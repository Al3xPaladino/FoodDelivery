<div class="wrapper" id="del4" style="display: none">
	...
	<div class="contat content-section">
        ...
        <form id="acquista" action="buyD.php" method="post" style="display: inline-block;">
            <input type="text" id="Nlat" name="Lati" style="display: none; opacity: 0;" readonly>
            <input type="text" id="Nlong" name="Long" style="display: none; opacity: 0;" readonly>
